...
class TestChunkedCrossoverOp extends TestCase with net.kogics.jiva.TestUtils with ProbabilityChecker[jbool] {
  ...
  def testCrossover = {
    val expectedPop= 
      Population(Chromosome("001101"), Chromosome("101101"), Chromosome("001101"), Chromosome("100000"))
    ...
    val crossator = new ChunkedCrossoverOp[jbool](0.5, rg, Array(1,4))
  ...
  def testOddNumberCrossoverWithAdd()  = {
    val expectedPop= 
      Population(Chromosome("001101"), Chromosome("001100"), Chromosome("100001"), Chromosome("101101"))
    ...
    val crossator = new ChunkedCrossoverOp[jbool](0.5, rg, Array(1,5))
    crossator.shuffler = new NoOpShuffler[Chromosome[jbool]]
    val pop2 = crossator.operate(initialPop)
  ...
  def testOddNumberCrossoverWithRemove()  = {
    val expectedPop= 
      Population(Chromosome("101101"), Chromosome("001101"), Chromosome("001001"), Chromosome("100100"))
    ...
    val crossator = new ChunkedCrossoverOp[jbool](0.5, rg, Array(3))
    crossator.shuffler = new NoOpShuffler[Chromosome[jbool]]
    val pop2 = crossator.operate(initialPop)
  ...
  override def createObjUnderTest(prob: Double): ChunkedCrossoverOp[jbool] = 
    new ChunkedCrossoverOp[jbool](prob, new Random, Array(1))    
}                                                                                                    